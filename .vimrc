...
autocmd GUIEnter * set transparency=500
...
nnoremap <silent> ,uf :<C-u>Unite file -no-split -no-quit<CR>
nnoremap <silent> ,ub :<C-u>Unite bookmark -winwidth=30 <CR>
nnoremap <silent> ,um :<C-u>Unite file_mru -winwidth=30 <CR>
nnoremap <silent> ,vf :<C-u>VimFiler -split -simple -winwidth=30 -no-split -no-quit<CR>
